...
class ARNavigationUI {
    ...
    static STYLES = `
        ...
        .arn-anim-forward {
            ...
            animation: arnIntoScreen 1.6s ease-in-out infinite;
        }
        /* Dikey telefonda "koridora doğru gidip geri gelme" hissi:
           perspective + translateZ ile ekranın içine (uzağa) küçülür, sonra yaklaşır.
           https://css-tricks.com/almanac/functions/t/translatez/ */
        @keyframes arnIntoScreen {
            0%, 100% {
        ...
        .arn-anim-forwardPerspective {
            transform-origin: center center;
            animation: arnForwardBack 1.4s ease-in-out infinite;
        }
